...
std::string CopyrightHolders(const std::string& strPrefix)
{
    ...
    // Order: Satoshi Nakamoto, Bitcoin Core, Satooshi Nakamoto, BitcoinII, Bitcoin Cash II
    strCopyrightHolders = strPrefix + " Satoshi Nakamoto\n";
    strCopyrightHolders += strPrefix + "The Bitcoin Core developers\n";
    strCopyrightHolders += strPrefix + " Satooshi Nakamoto\n";
    strCopyrightHolders += strPrefix + "The BitcoinII developers\n";
    strCopyrightHolders += strPrefix + copyright_devs;
    return strCopyrightHolders;
}

std::string LicenseInfo()
{
    const std::string URL_SOURCE_CODE = "<https://github.com/BitcoincashII>";
