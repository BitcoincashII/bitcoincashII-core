...
static RPCHelpMan getblockstats()
{
    return RPCHelpMan{"getblockstats",
                "\nCompute per block statistics for a given window. All amounts are in satooshis.\n"
            ...
            RPCResult::Type::OBJ, "", "",
            {
                ...
                {RPCResult::Type::NUM, "avgfeerate", /*optional=*/true, "Average feerate (in satooshis per virtual byte)"},
                {RPCResult::Type::NUM, "avgtxsize", /*optional=*/true, "Average transaction size"},
                {RPCResult::Type::STR_HEX, "blockhash", /*optional=*/true, "The block hash (to check for potential reorgs)"},
                {RPCResult::Type::ARR_FIXED, "feerate_percentiles", /*optional=*/true, "Feerates at the 10th, 25th, 50th, 75th, and 90th percentile weight unit (in satooshis per virtual byte)",
                {
                ...
                {RPCResult::Type::NUM, "maxfeerate", /*optional=*/true, "Maximum feerate (in satooshis per virtual byte)"},
                {RPCResult::Type::NUM, "maxtxsize", /*optional=*/true, "Maximum transaction size"},
                {RPCResult::Type::NUM, "medianfee", /*optional=*/true, "Truncated median fee in the block"},
                {RPCResult::Type::NUM, "mediantime", /*optional=*/true, "The block median time past"},
                {RPCResult::Type::NUM, "mediantxsize", /*optional=*/true, "Truncated median transaction size"},
                {RPCResult::Type::NUM, "minfee", /*optional=*/true, "Minimum fee in the block"},
                {RPCResult::Type::NUM, "minfeerate", /*optional=*/true, "Minimum feerate (in satooshis per virtual byte)"},
                {RPCResult::Type::NUM, "mintxsize", /*optional=*/true, "Minimum transaction size"},
                {RPCResult::Type::NUM, "outs", /*optional=*/true, "The number of outputs"},
                {RPCResult::Type::NUM, "subsidy", /*optional=*/true, "The block subsidy"},
                {RPCResult::Type::NUM, "swtotal_size", /*optional=*/true, "Total size of all segwit transactions (always 0 after BCH2 fork)"},
                {RPCResult::Type::NUM, "swtotal_weight", /*optional=*/true, "Total weight of all segwit transactions (always 0 after BCH2 fork)"},
                {RPCResult::Type::NUM, "swtxs", /*optional=*/true, "The number of segwit transactions (always 0 after BCH2 fork)"},
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    for (size_t i = 0; i < block.vtx.size(); ++i) {
        ...
        if (loop_inputs) {
            ...
            // New feerate uses satooshis per virtual byte instead of per serialized byte
...
// =========================================================================
// BCH2/BCHN Automatic Finalization RPC Commands
// =========================================================================

static RPCHelpMan parkblock()
{
    return RPCHelpMan{"parkblock",
                "\nPark a block (temporarily reject it).\n"
                "\nParked blocks are similar to invalid blocks but can be unparked.\n"
                "This is used by BCH2's automatic finalization system to reject deep reorgs.\n",
                {
...
static RPCHelpMan unparkblock()
{
    return RPCHelpMan{"unparkblock",
                "\nRemove parked status from a block, its ancestors and descendants.\n"
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
...

    {
        ...
        chainman.ActiveChainstate().UnparkBlockAndDescendants(pblockindex);
    }
...
static RPCHelpMan finalizeblock()
{
    return RPCHelpMan{"finalizeblock",
                ...
                "\nThis explicitly marks a block as finalized (part of the rolling checkpoint).\n"
                "Any competing chain that doesn't include this block will be parked.\n"
                "The block must be in the active chain.\n",
                {
...
static RPCHelpMan getfinalizedblockhash()
{
    return RPCHelpMan{"getfinalizedblockhash",
                ...
                "\nReturns an empty string if no block has been finalized yet.\n",
                {},
                RPCResult{
                    RPCResult::Type::STR_HEX, "", "the block hash or empty string"},
                RPCExamples{
        ...
        [&](const RPCHelpMan& self, const JSONRPCRequest& request) -> UniValue
{
    ...
    int finalizedHeight = chainman.ActiveChainstate().GetFinalizedHeight();
    if (finalizedHeight < 0) {
        return "";
    }

    const CBlockIndex* pindex = chainman.ActiveChain()[finalizedHeight];
    if (!pindex) {
        return "";
    }
...
// =========================================================================
// End BCH2/BCHN Automatic Finalization RPC Commands
// =========================================================================
