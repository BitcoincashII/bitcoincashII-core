...
const std::string CURRENCY_UNIT = "BCH2"; // One formatted unit
...
enum class FeeEstimateMode {
    ...
    BCH2_KVB,     //!< Use BCH2/kvB fee rate unit
...
public:
    ...
    std::string ToString(const FeeEstimateMode& fee_estimate_mode = FeeEstimateMode::BCH2_KVB) const;
