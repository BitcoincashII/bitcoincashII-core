...
#ifndef BITCOINII_PRIMITIVES_TOKEN_H
#define BITCOINII_PRIMITIVES_TOKEN_H
...
/**
 * CashTokens (CHIP-2022-02-CashTokens) support for BCH2.
 *
...
#endif // BITCOINII_PRIMITIVES_TOKEN_H
